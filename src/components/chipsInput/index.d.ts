...
declare class ChipsInput extends Component<OwnProps, State> {
    ...
    onFocus: () => void;
    onBlur: () => void;
    renderLabel(tag: ChipType, shouldMarkTag: boolean): React.JSX.Element;
    renderTag: (tag: ChipType, index: number) => React.JSX.Element;
    renderTagWrapper: (tag: ChipType, index: number) => React.JSX.Element;
    renderNewChip: () => React.JSX.Element[];
    renderTitleText: () => "" | React.JSX.Element | undefined;
    renderChips: () => React.JSX.Element[];
    renderCharCounter(): React.JSX.Element | undefined;
    renderUnderline: () => React.JSX.Element;
    renderTextInput(): React.JSX.Element;
    renderChipsContainer: () => React.JSX.Element;
