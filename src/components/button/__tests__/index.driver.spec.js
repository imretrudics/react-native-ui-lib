...
describe('Button', () => {
  ...
  it('should render a button', async () => {
    ...
    const buttonDriver = new ButtonDriver({
      component,
      testID: BUTTON_ID
    });
  ...
  describe('custom button', () => {
    ...
    it('should render the children with correct text', async () => {
      ...
      expect(buttonDriver.exists()).toBeTruthy();
      const childrenTextDriver = new TextDriver({
        component,
  ...
  describe('more complicated screen', () => {
    ...
    it('should change text values according to state changes from buttons pressing', async () => {
      ...
      const text1Driver = new TextDriver({
        testID: `text_1`,
        component
      });
      const text2Driver = new TextDriver({
        testID: `text_2`,
        component
      });
      const button1Driver = new ButtonDriver({
        testID: `${BUTTON_ID}1`,
        component
      });
      const button2Driver = new ButtonDriver({
        testID: `${BUTTON_ID}2`,
        component
      });
